...
<div class="content-body">
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td><a href="?page=group-discussion&update_view=true&update_id=<?= $id ?>">Update</a></td>
                    <td><a href="?page=group-discussion&delete_view=true&delete_id=<?= $id ?>">Delete</a></td>
                </tr>
            <?php
            }
            ?>
    ...
    <a href="?page=group-discussion&add_view=true">
