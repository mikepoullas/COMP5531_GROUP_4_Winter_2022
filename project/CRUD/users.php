...
if (isset($_POST['add_user'])) {
    ...
    if (count($errors) == 0) {
		...
		if (mysqli_query($conn, $add)) {
            ...
            // clear variables
            $id = $first_name = $last_name = $dob = $email = $username = $password_1 = $password_2 = $role_id = $table_name = "";
        } else {
            array_push($errors, "Error adding user to role table: ", mysqli_error($conn));
		}
...
if (isset($_POST['update_user'])) {
    ...
    if (count($errors) == 0) {
        $update = "UPDATE users set first_name = '$first_name', last_name = '$last_name', dob = '$dob', email = '$email', username = '$username'
                WHERE user_id ='$id'";
